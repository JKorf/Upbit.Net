...
namespace Upbit.Net.Objects.Models
{
    ...
    public record UpbitTicker
    {
        ...
        /// <summary>
        /// ["<c>trade_date_kst</c>"] Trade date kst
        /// </summary>
        [JsonPropertyName("trade_date_kst")]
        public string? TradeDateKst { get; set; }
        /// <summary>
        /// ["<c>trade_time_kst</c>"] Trade time kst
        /// </summary>
        ...
        /// <summary>
        /// ["<c>acc_trade_price</c>"] Accumulated trade volume in quote asset since UTC 00:00
        /// </summary>
        [JsonPropertyName("acc_trade_price")]
        public decimal QuoteVolume { get; set; }
        /// <summary>
        /// ["<c>acc_trade_price_24h</c>"] Accumulated trade volume in quote asset over the past 24 hours.
        /// </summary>
        [JsonPropertyName("acc_trade_price_24h")]
        public decimal QuoteVolume24h { get; set; }
        /// <summary>
        /// ["<c>acc_trade_volume</c>"] Accumulated trade volume in base asset since UTC 00:00
        /// </summary>
        [JsonPropertyName("acc_trade_volume")]
        public decimal Volume { get; set; }
        /// <summary>
        /// ["<c>acc_trade_volume_24h</c>"] Accumulated trade volume in base asset over last 24 hours
        /// </summary>
