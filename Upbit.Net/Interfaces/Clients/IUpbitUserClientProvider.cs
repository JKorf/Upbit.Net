...
namespace Upbit.Net.Interfaces.Clients
{
    ...
    /// </summary>
    public interface IUpbitUserClientProvider : IExchangeService
    {
        /// <summary>
        ...
        void InitializeUserClient(string userIdentifier, ApiCredentials credentials, UpbitEnvironment? environment = null);
        ...
        /// <param name="environment">The environment to use</param>
        IUpbitRestClient GetRestClient(string userIdentifier, ApiCredentials? credentials = null, UpbitEnvironment? environment = null);
        ...
        /// <param name="credentials">The credentials for the user. Required the first time a client is requested for this user unless <see cref="InitializeUserClient" /> has been called prior for this user.</param>
        /// <param name="environment">The environment to use</param>
        IUpbitSocketClient GetSocketClient(string userIdentifier, ApiCredentials? credentials = null, UpbitEnvironment? environment = null);
    }
}